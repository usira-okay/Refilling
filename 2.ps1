...
if (Test-Administrator) {   
    ...
    choco install sqlpackage googlechrome line teamviewer telegram 7zip adobereader discord postman vscode nodejs-lts git sourcetree visualstudio2022community visualstudio2022enterprise sql-server-management-studio potplayer microsoft-teams docker-desktop wsl2 openshot obs-studio zoom nuget.commandline steam-client ngrok skype office365business yt-dlp ffmpeg flameshot devtoys -y
