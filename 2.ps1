...
choco install googlechrome line teamviewer telegram 7zip adobereader discord postman vscode nodejs git sourcetree visualstudio2019community sql-server-management-studio potplayer microsoft-teams docker-desktop wsl2 openshot obs-studio office365business zoom nuget.commandline -y
