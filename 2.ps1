...
choco install sqlpackage googlechrome line teamviewer telegram 7zip adobereader discord postman vscode nodejs git sourcetree visualstudio2019community visualstudio2019enterprise visualstudio2022community sql-server-management-studio potplayer microsoft-teams docker-desktop wsl2 openshot obs-studio zoom nuget.commandline stream-client ngrok skype office365business -y
